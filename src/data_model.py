...
class Nutanixshell(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Nutanixshell'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype Nutanixshell
        """
        result = Nutanixshell(name=context.resource.name)
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Nutanixshell.User'] if 'Nutanixshell.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['Nutanixshell.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Nutanixshell.Password'] if 'Nutanixshell.Password' in self.attributes else None
    ...
    def networking_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Nutanixshell.Networking type'] if 'Nutanixshell.Networking type' in self.attributes else None
    ...
    def networking_type(self, value):
        ...
        :type value: str
        """
        self.attributes['Nutanixshell.Networking type'] = value
    ...
    def region(self):
        ...
        :rtype: str
        """
        return self.attributes['Nutanixshell.Region'] if 'Nutanixshell.Region' in self.attributes else None
    ...
    def region(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Nutanixshell.Region'] = value
    ...
    def networks_in_use(self):
        ...
        :rtype: str
        """
        return self.attributes['Nutanixshell.Networks in use'] if 'Nutanixshell.Networks in use' in self.attributes else None
    ...
    def networks_in_use(self, value=''):
        ...
        :type value: str
        """
        self.attributes['Nutanixshell.Networks in use'] = value
    ...
    def vlan_type(self):
        ...
        :rtype: str
        """
        return self.attributes['Nutanixshell.VLAN Type'] if 'Nutanixshell.VLAN Type' in self.attributes else None
    ...
    def vlan_type(self, value='VLAN'):
        ...
        :type value: str
        """
        self.attributes['Nutanixshell.VLAN Type'] = value
...
class Nutanix_Clone_From_VM(object):
    def __init__(self, name):
        """
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Nutanixshell.Nutanix_Clone_From_VM'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :type context: cloudshell.shell.core.driver_context.ResourceCommandContext
        :return:
        :rtype Nutanix_Clone_From_VM
        """
        result = Nutanix_Clone_From_VM(name=context.resource.name)
        for attr in context.resource.attributes:
            result.attributes[attr] = context.resource.attributes[attr]
        return result
    ...
    def cloudshell_model_name(self):
        ...
        :return:
        """
        return 'Nutanix_Clone_From_VM'

    @property
    def cloned_vm_uuid(self):
        """
        :rtype: str
        """
        return self.attributes['Nutanixshell.Nutanix_Clone_From_VM.Cloned VM UUID'] if 'Nutanixshell.Nutanix_Clone_From_VM.Cloned VM UUID' in self.attributes else None

    @cloned_vm_uuid.setter
    def cloned_vm_uuid(self, value=''):
        """
        The id of the VM or Snapshot the App will be cloned from.
        :type value: str
        """
    ...
    def autoload(self):
        ...
        :rtype: bool
        """
        return self.attributes['Nutanixshell.Nutanix_Clone_From_VM.Autoload'] if 'Nutanixshell.Nutanix_Clone_From_VM.Autoload' in self.attributes else None
    ...
    def autoload(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Nutanixshell.Nutanix_Clone_From_VM.Autoload'] = value
    ...
    def wait_for_ip(self):
        ...
        :rtype: bool
        """
        return self.attributes['Nutanixshell.Nutanix_Clone_From_VM.Wait for IP'] if 'Nutanixshell.Nutanix_Clone_From_VM.Wait for IP' in self.attributes else None
    ...
    def wait_for_ip(self, value=True):
        ...
        :type value: bool
        """
        self.attributes['Nutanixshell.Nutanix_Clone_From_VM.Wait for IP'] = value
